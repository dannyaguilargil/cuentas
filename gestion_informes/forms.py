...
class finforme(forms.ModelForm):
    class Meta:
        model = informe
        fields = ['nombre','entecontrol','normativa','dependencia','descripcion','fechaentregainicial','periodicidad','periodicidadtipo','totalentregas','alarmas']#pendiente totalentregas
