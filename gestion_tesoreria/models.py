...
class cuentatesoreria(models.Model):
    ...
    validacionsupervisor = models.CharField(max_length=40, verbose_name='Validacion de la cuenta')##aqui debe ir si aprueba la cuenta o no
